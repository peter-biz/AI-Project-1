...
class GradientDescent:
    ...
    def fit(self):
        self.classifier = OneVsRestClassifier(SGDClassifier(random_state=255))  # Create classifier object
        return self.classifier.fit(self.X_train, self.y_train).decision_function(self.X_test)  # Train and test data
